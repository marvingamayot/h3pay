            ...
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                ...
                <a href="javascript:;"
                    ...
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 7L4 7" stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                        <path opacity="0.5" d="M20 12L4 12" stroke="#9C603B" stroke-width="1.5"
                            stroke-linecap="round" />
                        <path d="M20 17L4 17" stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                    </svg>
                </a>
            </div>
            ...
            <div x-data="header"
                        ...
                        <div class="relative">
                            ...
                            <button type="button"
                                ...
                                <svg class="mx-auto" width="16" height="16" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="11.5" cy="11.5" r="9.5" stroke="#9C603B" stroke-width="1.5"
                                        opacity="0.5" />
                                    <path d="M18.5 18.5L22 22" stroke="#9C603B" stroke-width="1.5"
                                        stroke-linecap="round" />
                                </svg>
                            </button> -->
                            <button type="button"
                                ...
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle opacity="0.5" cx="12" cy="12" r="10" stroke="#9C603B"
                                        stroke-width="1.5" />
                                    <path d="M14.5 9.50002L9.5 14.5M9.49998 9.5L14.5 14.5" stroke="#9C603B"
                ...
                <div>
                    <a href="javascript:;" x-cloak x-show="$store.app.theme === 'light'" href="javascript:;"
                        ...
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="12" cy="12" r="5" stroke="#9C603B" stroke-width="1.5" />
                            <path d="M12 2V4" stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M12 20V22" stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M4 12L2 12" stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M22 12L20 12" stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                            <path opacity="0.5" d="M19.7778 4.22266L17.5558 6.25424" stroke="#9C603B"
                                stroke-width="1.5" stroke-linecap="round" />
                            <path opacity="0.5" d="M4.22217 4.22266L6.44418 6.25424" stroke="#9C603B"
                                stroke-width="1.5" stroke-linecap="round" />
                            <path opacity="0.5" d="M6.44434 17.5557L4.22211 19.7779" stroke="#9C603B"
                                stroke-width="1.5" stroke-linecap="round" />
                            <path opacity="0.5" d="M19.7778 19.7773L17.5558 17.5551" stroke="#9C603B"
                                stroke-width="1.5" stroke-linecap="round" />
                        </svg>
                    </a>
                    ...
                    <a href="javascript:;" x-cloak x-show="$store.app.theme === 'system'" href="javascript:;"
                        ...
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                stroke="#9C603B" stroke-width="1.5" />
                            <path opacity="0.5" d="M22 21H2" stroke="#9C603B" stroke-width="1.5"
                                stroke-linecap="round" />
                            <path opacity="0.5" d="M15 15H9" stroke="#9C603B" stroke-width="1.5"
                                stroke-linecap="round" />
                        </svg>
                    </a>
                </div>
                    ...
                    <a href="javascript:;"
                        ...
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                ...
                                stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                            <circle cx="19" cy="5" r="3" stroke="#9C603B" stroke-width="1.5" />
                        </svg>
                    </a>
                            ...
                            <li class="border-t border-white-light text-center dark:border-white/10 mt-5 ">
                                <div class="flex items-center px-4 py-4 text-primary font-semibold group dark:text-gray-400  justify-center cursor-pointer"
                                    ...
                                    <svg class="w-4 h-4 group-hover:translate-x-1 transition duration-300 ltr:ml-1 rtl:mr-1"
                                        ...
                                        <path d="M4 12H20M20 12L14 6M20 12L14 18" stroke="#9C603B"
                    ...
                    <a href="javascript:;"
                        ...
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M7.5 19C8.15503 20.7478 9.92246 22 12 22C14.0775 22 15.845 20.7478 16.5 19"
                                stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M12 6V10" stroke="#9C603B" stroke-width="1.5" stroke-linecap="round" />
                        </svg>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#9C603B"
