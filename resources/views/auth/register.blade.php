<x-guest-layout>
    ...
    <div class="flex min-h-screen">
        <div
            ...
            <div class="w-full mx-auto mb-5"><img src="/assets/images/auth-cover.png" alt="coming_soon"
                    class="lg:max-w-[370px] xl:max-w-[500px] mx-auto" /></div>
            <h3 class="text-3xl font-bold mb-4 text-center">Discover Luxury and Comfort</h3>
            <p>At Anaa, we believe in creating unforgettable experiences for our guests. Whether you're here for business or leisure, we strive to provide you with exceptional service and comfort throughout your stay.</p>
        </div>
